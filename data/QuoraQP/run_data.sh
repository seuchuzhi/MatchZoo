...
python3 prepare_mz_data.py

# generate word embedding
GLOVE='.'
python3 gen_w2v.py  $GLOVE/glove.840B.300d.txt word_dict.txt embed_glove_d300
python3 norm_embed.py embed_glove_d300 embed_glove_d300_norm
python3 gen_w2v.py  $GLOVE/glove.6B.50d.txt word_dict.txt embed_glove_d50
...
python3 gen_hist4drmm.py 60

# generate data bin sums for anmm model
python3 gen_binsum4anmm.py 20 # the default number of bin is 20
